...
export default function SessionError({
  ...
  useEffect(() => {
    console.error('[AgentDecode] Session page error:', error)
  }, [error])
    ...
    <div className="p-8 max-w-7xl mx-auto w-full">
      <div className="text-center max-w-md mx-auto space-y-6 py-20">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold text-foreground">Failed to load session</h2>
          <p className="text-sm text-muted-foreground leading-relaxed">
            We couldn&apos;t load this session&apos;s trace data. Please try again.
          </p>
        </div>
